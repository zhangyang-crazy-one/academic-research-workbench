...
| 2 | A strict ARS literature entry becomes a deterministic source -> span -> claim digest chain through installed schemas. | ✓ VERIFIED | `research_source_from_ars_entry` now mirrors authoritative ARS scalar and collection constraints without bridge-only caps: 257-item collections, >1 MiB private fields and 18 long-field variants round-trip through the exact bibliographic digest, while installed manifest schemas accept every copied field. Required patterns, RFC3339, NUL, explicit-null and allOf/cross-field rules still reject at both bundled and bridge boundaries; source/span/link builders recompute canonical upstream digests. |
...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 binds the cycle-free build-identity metadata projection; live verification recomputes manifest coverage and closes the referenced host-canary evidence graph. Final clean-tree suite/ARS hashes remain `310dc2036a797543c01e82e34168efe9f263177091868bf315c8f7e7b40a3607` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `949a2ba9756dc40c0e8fc6fe43007cd5b13c07e5990b7eb18854a109c325ed9d`. Source freshness, quality gates and a fresh isolated stage all pass. |
