...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate and five staged PASS evidence receipts before binding the cycle-free projection. File-contract authority is independently regenerated from the staged checked schemas: the staged header must match those bytes exactly, so paired header/identity rewrites, inactive preprocessor decoys, continuations and outer-header aliases all reject. The content-addressed `.python-version` is restricted to qualified 3.13/3.14 runtimes. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `cf2ad0861ab8b1ea60e95723bd09490b4a2394165b96fbd479f89cf16edce3eb`. |
