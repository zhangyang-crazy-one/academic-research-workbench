...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath and derived aggregate, including five staged PASS evidence receipts, before binding the cycle-free metadata projection; semantic file-contract identity must equal the exact `ARW_FILES_CONTRACT_SHA256` embedded in the staged header, never its outer file hash. Installed verification no longer depends on the original build evidence tree. Final clean-tree suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `216d6552e598c7665d6064c83784192ebdef6f930f3fd347c3587151936754cb`. |
