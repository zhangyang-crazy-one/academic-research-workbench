...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate before binding the cycle-free projection, and each of the five staged evidence files must satisfy its full strict producer contract (NetworkVerdict/LegalVerdict/PreVendorReceipt) with `technical_qualification` derived from semantics, never self-asserted. File-contract authority is independently regenerated from the staged checked schemas; native post-patch and upstream-test trees are pinned to verifier constants, so paired manifest/identity rewrites reject. The content-addressed `.python-version` is restricted to qualified 3.13/3.14 runtimes. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `ccba2d26c77af778c096cab869a351ff85d4efc7273cdbfc8295629287e9972b`. |
