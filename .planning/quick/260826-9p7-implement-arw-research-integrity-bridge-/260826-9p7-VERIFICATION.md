...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate before binding the cycle-free projection. The pre-vendor gate binds its exact command sequence and eight-phase absence proof; all 184 `(component, kind, relative path, sha256)` legal-input rows must exactly equal the staged source-manifest inventory after deterministic prefix normalization, with duplicates, subsets and dummy rows rejected. Components/licenses remain cross-bound to manifest/live bytes. Native five-file bundles require exact command/suite identity, pinned test tree and zero status; file-contract authority is independently regenerated. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `f7197a893895eae1ab3528fb07c6f8f25da09c6695991839d010ef920b9af6f9`. |
