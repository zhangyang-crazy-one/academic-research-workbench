...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate before binding the cycle-free projection. The pre-vendor native gate requires exactly three ordered producer commands with pinned argv/output paths, real UTC intervals and zero status; its vendor-source absence proof is the exact eight-record `{phase, exists:false}` sequence from before, through every fetch/gate/notice phase, to after. Components/licenses remain cross-bound to manifest/live bytes. Native five-file bundles require exact command and suite identity, pinned test tree and zero status. File-contract authority remains independently regenerated from staged schemas. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `4fa70dd5267294c9e0ce94a6cf8750da097be2f9f9e93fa93873139f823c6a83`. |
