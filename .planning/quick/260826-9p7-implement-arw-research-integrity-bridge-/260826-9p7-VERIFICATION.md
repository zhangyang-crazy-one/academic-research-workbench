...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate and five staged PASS evidence receipts before binding the cycle-free projection. File-contract identity comes from exactly one active, comment-safe `#define ARW_FILES_CONTRACT_SHA256`; duplicate/comment decoys and outer-header aliases reject. `runtime.build_interpreter` must equal the content-addressed staged `.python-version`, while installed verification remains independent of its own interpreter. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `c1100acf3c22dbb65ff6465bbcea2d14389fe34ca40f6425429a84401901e496`. |
