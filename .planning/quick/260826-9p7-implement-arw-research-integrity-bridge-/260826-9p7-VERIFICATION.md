...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate before binding the cycle-free projection. Pre-vendor commands require status zero; components are cross-bound to the staged source manifest; legal rows are pinned and checked against live `LICENSES/` bytes; timestamps are real UTC calendar datetimes. Each native surface is now a five-file bundle (network verdict, command, sanitizer verdict, pinned test-suite digest, zero status): exact argv/environment/suite contracts distinguish upstream, ASan/UBSan and TSan, so copying or permuting passing verdicts cannot substitute for a sanitizer run. File-contract authority remains independently regenerated from staged schemas. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `39802c6117f5820d9ed91cfcf9add52a909bd4478319a1061fe0c2ec5e8198af`. |
