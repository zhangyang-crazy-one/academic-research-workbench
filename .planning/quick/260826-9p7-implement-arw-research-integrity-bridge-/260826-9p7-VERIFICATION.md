...
| 6 | Stage/schema/SBOM/provenance metadata is exact and self-consistent. | ✓ VERIFIED | Integration lock v2 live-recomputes every staged digestPath/aggregate before binding the cycle-free projection. The pre-vendor native gate requires exactly three ordered producer commands with pinned argv/output paths, real UTC intervals and zero status; components and licenses remain cross-bound to manifest/live bytes. Each native surface is a five-file bundle whose exact command argv/environment and sanitizer suite must equal the current surface, with pinned test-tree digest and zero status, so copying, permuting or relabeling verdicts rejects. File-contract authority remains independently regenerated from staged schemas. Final suite/ARS hashes remain `1ef564d7131b087891f363032dccc7c92aa3096484b127d2c25947800e10e247` / `dc021dbca00df0459a6282e18276a0295c47b2432aaffc6462734ae8a503e903`; actual and declared SBOM SHA-256 are both `d8e37819ef3677cc67104fbd61e5638ca2e76b6a91cbc63994f4345f89fd0f1a`. |
