...
CAPABILITIES: tuple[str, ...] = (
    ...
    "research.literature",
    "research.artifact.compile",
    "research.artifact.inspect",
    "research.artifact.reproduce",
    "research.deep_survey",
    "research.learning.observe",
    "research.learning.heuristic.extract",
    "research.learning.heuristic.inspect",
    "research.learning.heuristic.evaluate",
    "research.learning.heuristic.qualify",
    "research.learning.heuristic.reject",
    "research.learning.promote",
